...
def get_data():
    ...
    fields = ['case_id', 'patch_size', 'patch_min_x_pixel', 'patch_min_y_pixel', 'patch_polygon_area',
              ...
              'circularity_segment_std', 'elongation_segment_mean', 'elongation_segment_std',
              'r_GradientMean_segment_mean', 'r_GradientMean_segment_std', 'b_GradientMean_segment_mean',
        ...
        if items is not None:
            ...
            for x in range(start, stop):
                ...
                if is_number(val1) and is_number(val2):
                    ...
                    if is_number(my_float):
                        row_vals.append(my_float)
                    else:
                        print('NaN', val1, val2, my_float)
