...
if __name__ == '__main__':
  ...
  for item in image_list:  
    ...
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"b_GradientMean_segment_mean": { "$ne": "n/a" }},
      ...
      break;      
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"b_GradientMeansegment_std": { "$ne": "n/a" }},
                                          {"b_GradientMeansegment_std":1,"_id":0}).sort("b_GradientMeansegment_std",1).limit(1):
      min_b_GradientMeansegment_std = record["b_GradientMeansegment_std"];
      break;                                                          
    for record in patch_level_dataset.find({"case_id":case_id,"user":user,"tumorFlag":region_type,"b_GradientMeansegment_std": { "$ne": "n/a" }},
                                           {"b_GradientMeansegment_std":1,"_id":0}).sort("b_GradientMeansegment_std",-1).limit(1):
      max_b_GradientMeansegment_std = record["b_GradientMeansegment_std"];
      break;    
    print "min_r_GradientMean_segment_mean,max_r_GradientMean_segment_mean,min_r_GradientMean_segment_std,max_r_GradientMean_segment_std,min_b_GradientMean_segment_mean,max_b_GradientMean_segment_mean,min_b_GradientMeansegment_std,    max_b_GradientMeansegment_std"; 
    print min_r_GradientMean_segment_mean,max_r_GradientMean_segment_mean,min_r_GradientMean_segment_std,max_r_GradientMean_segment_std,min_b_GradientMean_segment_mean,max_b_GradientMean_segment_mean,min_b_GradientMeansegment_std,    max_b_GradientMeansegment_std; 
    ...
    for feature_record in patch_level_dataset.find({"case_id":case_id,
      ...
      b_GradientMeansegment_std=feature_record["b_GradientMeansegment_std"];
      b_GradientMeansegment_std_normalized=float(b_GradientMeansegment_std - min_b_GradientMeansegment_std)/float(max_b_GradientMeansegment_std-min_b_GradientMeansegment_std);                
      ...
      save2Objects(case_id,"b_GradientMean_segment_std",patch_size,tmp_patch_polygon,b_GradientMeansegment_std_normalized);
      ...
      print index2,b_GradientMean_segment_mean_normalized,b_GradientMeansegment_std_normalized,r_cytoIntensityMean_segment_mean_normalized,r_cytoIntensityMean_segment_std_normalized;
      if(b_GradientMean_segment_mean_normalized>1.0 or b_GradientMean_segment_mean_normalized<0.0):
        print "wrong";
        exit();       
      if(b_GradientMeansegment_std_normalized>1.0 or b_GradientMeansegment_std_normalized<0.0):
        print "wrong";
        exit();
